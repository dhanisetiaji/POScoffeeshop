              ...
              <div class="card-body">
                ...
                <thead>
                  ...
                  <tr>
                    ...
                    <td><?php echo htmlentities($res->password);?></td>
                    <td><?php echo htmlentities($res->user_level);?></td>
                    <td>
                        <a type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#MyModal<?php echo $res->id_login;?>"><i class="fas fa-edit"></i></a>
